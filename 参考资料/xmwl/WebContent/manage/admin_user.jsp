    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/xmwl/manage/admin_douserselect" method="get">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="admin_useradd.jsp"><i class="icon-font"></i>添加用户</a>
                ...
                <div class="result-content">
                    ...
                    <div class="list-page"> 共${tsum }条记录，当前${cpage}/${tpage}页
                    <a href="admin_douserselect?cp=1"> 首页</a>
                    <a href="admin_douserselect?cp=${cpage-1==0?1:cpage-1 }"> 上页</a>
                    <a href="admin_douserselect?cp=${cpage+1>tpage?tpage:cpage+1 }"> 下页</a>
